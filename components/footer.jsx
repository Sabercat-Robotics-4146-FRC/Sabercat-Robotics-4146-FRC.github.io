    ...
    <footer className="flex flex-wrap gap-y-8 min-[800px]:justify-center min-[800px]:gap-y-0 min-[800px]:gap-x-8 lg:gap-x-16 bg-zinc-700 px-8 py-10 min-[800px]:py-20 shadow-black shadow-[0_8px_16px]">
      <section className="w-full min-[800px]:w-max min-[800px]:max-w-xs">
        ...
        <nav className="flex flex-col flex-wrap text-slate-100">
          <Link href="/tax-credit" className="transition-colors duration-300 hover:text-yellow-500 focus-visible:text-yellow-500">Tax Credit</Link>
          <Link href="/sponsors-and-partners" className="transition-colors duration-300 hover:text-yellow-500 focus-visible:text-yellow-500">Sponsors & Partners</Link>
          <Link href="/mentors" className="transition-colors duration-300 hover:text-yellow-500 focus-visible:text-yellow-500">Mentors</Link>
        </nav>
      </section>
      <section className="w-full min-[800px]:w-max min-[800px]:max-w-xs">
        <h2 className="font-medium text-slate-100 text-3xl">Learn More</h2>
        <nav className="flex flex-col flex-wrap text-slate-100">
          <Link href="/awards" className="transition-colors duration-300 hover:text-yellow-500 focus-visible:text-yellow-500">Awards</Link>
          <Link href="/innovation-center" className="transition-colors duration-300 hover:text-yellow-500 focus-visible:text-yellow-500">Innovation Center</Link>
        </nav>
      </section>
      <section className="w-full min-[800px]:w-max min-[800px]:max-w-xs">
