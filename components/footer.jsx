  ...
  return (
    <footer className="flex flex-wrap gap-y-8 min-[800px]:justify-center min-[800px]:gap-y-0 min-[800px]:gap-x-8 lg:gap-x-16 bg-zinc-700 px-8 py-10 min-[800px]:py-20 shadow-black shadow-[0_8px_16px]">
      ...
      <section className="w-full min-[800px]:w-max min-[800px]:max-w-xs">
        ...
        <nav className="flex flex-col flex-wrap text-slate-100">
          <a href="https://www.instagram.com/sabercats4146/" target="_blank" rel="noopener noreferrer" className="fill-slate-100 transition-colors duration-300 hover:text-red-500 hover:fill-red-500 focus-visible:text-red-500 focus-visible:fill-red-500">
          ...
          <a href="https://www.github.com/Sabercat-Robotics-4146-FRC/" target="_blank" rel="noopener noreferrer" className="fill-slate-100 transition-colors duration-300 hover:text-red-500 hover:fill-red-500 focus-visible:text-red-500 focus-visible:fill-red-500">
          ...
          <a href="https://www.linkedin.com/in/sabercat-robotics-460090251/" target="_blank" rel="noopener noreferrer" className="fill-slate-100 transition-colors duration-300 hover:text-red-500 hover:fill-red-500 focus-visible:text-red-500 focus-visible:fill-red-500">
            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512" className="inline mr-1 mb-1.5">
          ...
          <a href="https://www.twitter.com/Sabercats4146" target="_blank" rel="noopener noreferrer" className="fill-slate-100 transition-colors duration-300 hover:text-red-500 hover:fill-red-500 focus-visible:text-red-500 focus-visible:fill-red-500">
