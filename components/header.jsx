...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 flex flex-wrap items-center justify-center space-x-2 space-y-2 md:justify-between py-5 px-4 bg-white border-b shadow-black shadow-[0_-8px_16px]">
