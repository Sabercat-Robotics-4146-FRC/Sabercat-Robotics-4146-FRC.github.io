    ...
    <main>
      ...
      <main className="flex flex-col flex-wrap justify-center items-center text-center py-16 px-6 text-neutral-900/75">
        ...
        <main className="flex flex-col flex-wrap md:grid md:grid-cols-3 -mx-6 w-full gap-6">
          ...
          {/* <Card title="Blog" description="The Sabercat Robotics blog; your perfect source for anything related to FIRST and our team." href="/blog" src="/assets/img/15.jpg" /> */}
          ...
          <section className="w-full">
            <main className="text-start pointer-events-none">
              <div className="pb-[66.72%] bg-gray-300/50 relative">
                <svg className="fill-zinc-800/50 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512" fill="#27272a">
                  <title>Clock Icon</title>
                  <path d="M464 256A208 208 0 1 1 48 256a208 208 0 1 1 416 0zM0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zM232 120V256c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2V120c0-13.3-10.7-24-24-24s-24 10.7-24 24z"></path>
                </svg>
                <span className="sr-only">Disabled Card</span>
              </div>
              <h3 className="px-2 text-neutral-900/50 text-2xl mt-4 mb-2">Coming Soon</h3>
              <p className="px-2 text-neutral-900/[0.375]">Feel free to contact us with your ideas about new pages and components.</p>
            </main>
          </section>
        </main>
        <EmailForm />
